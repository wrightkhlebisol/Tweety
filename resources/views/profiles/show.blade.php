...
<header class="mb-6 relative">
    ...
    <div class="flex justify-between items-center mb-4">
        ...
        <div>
            <a href="#" class="rounded-full text-xs shadow py-2 px-4 border border-gray-300 text-black">Edit Profile</a>
            <a href="#" class="bg-blue-500 rounded-full shadow text-xs py-2 px-4 text-white">Follow Me</a>
        </div>
